    ...
    return (
        <div>
            <div className="flex flex-row">
                <div className="w-6/12 flex flex-col justify-evenly items-center">
                    <h1 className="text-center text-6xl font-bold font-mono text-indigo-800">
                        Arics Finance
                    </h1>
                    <Image
                        ...
                        width={500}
                        height={400}
                        className="mx-auto w-[500px] h-80"
                    />
                </div>
